...
namespace ShapeKeyTools
{
    ...
    internal static class ShapeKeyToolSettings
    {
        ...
        private const string DEBUG_VERBOSE_KEY = "ShapeKeyTool_DebugVerbose";
        ...
        {
            get => EditorPrefs.GetBool(DEBUG_VERBOSE_KEY, false);
            set => EditorPrefs.SetBool(DEBUG_VERBOSE_KEY, value);
        }
        ...
        public static void Reset()
        {
            ...
            EditorPrefs.DeleteKey(DEBUG_VERBOSE_KEY);
            Initialize();
        }
    }
} 