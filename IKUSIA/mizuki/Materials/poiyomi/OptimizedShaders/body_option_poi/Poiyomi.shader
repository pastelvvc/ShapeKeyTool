Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/e6ec656f3d3b9a34b8941374120446aa"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, (0.386 /*_ShadowBorder*/), (0.859 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeNonLinearNoSaturate(lightMap.y, (0.501 /*_Shadow2ndBorder*/), (0.493 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeNonLinearNoSaturate(lightMap.z, (0.25 /*_Shadow3rdBorder*/), (0.1 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (0.386 /*_ShadowBorder*/), (0.859 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, (0.386 /*_ShadowBorder*/), (0.859 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeLinearNoSaturate(lightMap.y, (0.501 /*_Shadow2ndBorder*/), (0.493 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeLinearNoSaturate(lightMap.z, (0.25 /*_Shadow3rdBorder*/), (0.1 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (0.386 /*_ShadowBorder*/), (0.859 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				lns = saturate(lns);
				float3 indirectColor = 1;
				if (float4(1,0.7524076,0.7524076,1).a > 0)
				{
					#if defined(PROP_SHADOWCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					indirectColor = lerp(float3(1, 1, 1), shadowColorTex.rgb, shadowColorTex.a) * float4(1,0.7524076,0.7524076,1).rgb;
				}
				if (float4(0.8562991,0.5846539,0.5846539,1).a > 0)
				{
					#if defined(PROP_SHADOW2NDCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					shadow2ndColorTex.rgb = lerp(float3(1, 1, 1), shadow2ndColorTex.rgb, shadow2ndColorTex.a) * float4(0.8562991,0.5846539,0.5846539,1).rgb;
					lns.y = float4(0.8562991,0.5846539,0.5846539,1).a - lns.y * float4(0.8562991,0.5846539,0.5846539,1).a;
