Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/36096381ac6a7b74787951f4c8e2ebc2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				indirectColor = lerp(indirectColor, 1, lns.w * float4(1,0.009721208,0,1).rgb);
