Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/59bba01bf72f40549adc81c88cb25ad2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					poiLight.directColor = min(poiLight.directColor, (1.02 /*_LightingCap*/));
					poiLight.indirectColor = min(poiLight.indirectColor, (1.02 /*_LightingCap*/));
				}
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0.7892805,0.7892805,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(1,0.7892805,0.7892805,1).a;
